...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/umbrella_cpp

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/umbrella_cpp: ${OBJECTFILES}
...
${OBJECTDIR}/hello_world_mp.o: hello_world_mp.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hello_world_mp.o hello_world_mp.cpp
...
${OBJECTDIR}/wham.o: wham.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wham.o wham.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/umbrella_cpp
